    ...
    TEST_SUITE("xlstsq_extended")
    {
        ...
        */
        TEST_CASE("lstsq1")
        {
            ...
            xarray<double> py_res0 = {0.9952565679768294, 0.6379298291900682, 0.4165893035659636};
            // py_res1 = np.linalg.lstsq(a, b)[1]
            xarray<double> py_res1 = {0.3378625895661749};
            // py_res2 = np.linalg.lstsq(a, b)[2]
            int py_res2 = 3;
            // py_res3 = np.linalg.lstsq(a, b)[3]
            xarray<double> py_res3 = {2.081504268698354, 1.0127562495165512, 0.5990446582801109};
        ...
        */
        TEST_CASE("lstsq20")
        {
            ...
            // py_res0 = np.linalg.lstsq(a, b)[0]
            xarray<double> py_res0 = {-1.655587220862159, 1.7320451450169407, 1.9787446378934204};
            // py_res1 = np.linalg.lstsq(a, b)[1]
        ...
        TEST_CASE("lstsq5")
        {
            ...
            xarray<double> py_res0 = {
                {0.7695214798127483, 0.7695214798127483, 0.7695214798127483, 0.7695214798127483,
                 ...
                 0.7695214798127483, 0.7695214798127483, 0.7695214798127483, 0.7695214798127483,
                 0.7695214798127483, 0.7695214798127483, 0.7695214798127483, 0.7695214798127483},
                {0.3603784058338764, 0.3603784058338764, 0.3603784058338764, 0.3603784058338764,
                 0.3603784058338764, 0.3603784058338764, 0.3603784058338764, 0.3603784058338764,
                 0.3603784058338764, 0.3603784058338764, 0.3603784058338764, 0.3603784058338764,
                 0.3603784058338764, 0.3603784058338764, 0.3603784058338764, 0.3603784058338764,
                 0.3603784058338764, 0.3603784058338764, 0.3603784058338764, 0.3603784058338764},
                {-0.0288908468951096, -0.0288908468951096, -0.0288908468951096, -0.0288908468951096,
                 -0.0288908468951096, -0.0288908468951096, -0.0288908468951096, -0.0288908468951096,
                 -0.0288908468951096, -0.0288908468951096, -0.0288908468951096, -0.0288908468951096,
                 -0.0288908468951096, -0.0288908468951096, -0.0288908468951096, -0.0288908468951096,
                 -0.0288908468951096, -0.0288908468951096, -0.0288908468951096, -0.0288908468951096},
                {0.2739420182164652, 0.2739420182164652, 0.2739420182164652, 0.2739420182164652,
                 0.2739420182164652, 0.2739420182164652, 0.2739420182164652, 0.2739420182164652,
                 0.2739420182164652, 0.2739420182164652, 0.2739420182164652, 0.2739420182164652,
                 0.2739420182164652, 0.2739420182164652, 0.2739420182164652, 0.2739420182164652,
                 0.2739420182164651, 0.2739420182164651, 0.2739420182164651, 0.2739420182164651},
                {0.6381721647626308, 0.6381721647626308, 0.6381721647626308, 0.6381721647626308,
                 0.6381721647626308, 0.6381721647626308, 0.6381721647626308, 0.6381721647626308,
                 0.6381721647626308, 0.6381721647626308, 0.6381721647626308, 0.6381721647626308,
                 0.6381721647626308, 0.6381721647626308, 0.6381721647626308, 0.6381721647626308,
                 0.6381721647626308, 0.6381721647626308, 0.6381721647626308, 0.6381721647626308}
            ...
            // py_res1 = np.linalg.lstsq(a, b)[1]
            xarray<double> py_res1 = {0.668387503414133, 0.668387503414133, 0.668387503414133,
                                      0.668387503414133, 0.668387503414133, 0.668387503414133,
                                      0.668387503414133, 0.668387503414133, 0.668387503414133,
                                      0.668387503414133, 0.668387503414133, 0.668387503414133,
                                      0.668387503414133, 0.668387503414133, 0.668387503414133,
                                      0.668387503414133, 0.668387503414133, 0.668387503414133,
                                      0.668387503414133, 0.668387503414133};
            // py_res2 = np.linalg.lstsq(a, b)[2]
            int py_res2 = 5;
            // py_res3 = np.linalg.lstsq(a, b)[3]
